    ...
    return (
        ...
        <div>
            ...
            <section>
                <div className='lg:container lg:mx-auto px-5 lg:px-20 lg:pt-4 mb-2'>
                    <h1 data-aos="fade-right"
                        data-aos-easing="linear"
                        data-aos-duration="1500"
                        className=' text-center text-4xl lg:text-5xl font-semibold text-black'> Toy Zone Gallery  </h1>
                    <p data-aos="fade-up"
                        data-aos-easing="linear"
                        data-aos-duration="1500"
                        className='text-center pt-6 px-6'>Toy Zone Gallery is a haven for toy lovers, offering a captivating space to immerse oneself in the world of toys, <br /> relive cherished memories, discover new favorites, and connect with fellow enthusiasts.</p>
            ...
            <section className=' bg-slate-100'>
                <div className='lg:container lg:mx-auto px-5 lg:px-20 lg:pt-4 '>
                    <h1 data-aos="fade-right"
                        data-aos-easing="linear"
                        data-aos-duration="1500"
                        className=' pt-12 text-center text-4xl lg:text-5xl font-semibold text-black'> Toys Category  </h1>
                    <p data-aos="fade-up"
                        data-aos-easing="linear"
                        data-aos-duration="1500"
                        className='text-center pt-6 px-6 pb-4'>Shopping now at Toy Zone allows you to explore a wide variety of toys, shop conveniently from  the comfort <br /> of your home, and provide children with
            ...
            <section >
                <div className='lg:container lg:mx-auto px-5 lg:px-20 lg:pt-4 '>
                    <h1 data-aos="fade-right"
                        data-aos-easing="linear"
                        data-aos-duration="1500"
                        className=' pt-12 text-center text-4xl lg:text-5xl font-semibold text-black'> Our Client Review  </h1>
                    <p data-aos="fade-up"
                        data-aos-easing="linear"
                        data-aos-duration="1500"
                        className='text-center pt-6 px-6 pb-4'>Delighted Customer Shares Their Fantastic Experience with Toy Zone: A True Toy Wonderland! </p>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-10  mb-16 lg:px-20 px-5'>
                        ...
                        <div data-aos="fade-down"
                            ...
                            <div className="card-body">
                                ...
                                <h2 className="card-title text-2xl">Ashik Ahmed</h2>
                        ...
                        <div data-aos="fade-up"
                            ...
                            <div className="card-body">
                                <h2 className="card-title text-2xl">Mimi Islam</h2>
            ...
            <section className=' bg-slate-100' >
                ...
                <div className=" container lg:container  lg:mx-auto px-12 lg:px-28 py-10 mt-28 mb-28">
                    <div className="flex flex-col lg:flex-row justify-between  items-center gap-12 lg:gap-32 ">
                        ...
                        <div>
                            <h1 data-aos="fade-right"
                                data-aos-easing="linear"
                                data-aos-duration="1500"
                                className="text-5xl font-bold">Subscribe for our new arrival !!!. </h1>
                            <div className="form-control text-center mt-6">

                                <label className="input-group">
                                    <span>Email</span>
                                    <input type="text" placeholder="toyzone@site.com" className="input input-bordered" />
                                </label>
                            </div>
                            <div data-aos="fade-up"
                                data-aos-easing="linear"
                                data-aos-duration="1500">
                                <p class="pt-7 pb-7 text-justify">By subscribing, you will receive timely updates about the new arrivals at Toy Zone.Subscribers often receive exclusive offers, promotions, and discounts. Toy Zone may offer special deals to their subscribers, giving you the opportunity to snag new toys at discounted prices or enjoy other perks not available to non-subscribers. This can help you save money and make your toy shopping experience even more rewarding.</p>
                        ...
                        <div data-aos="flip-left"
                            ...
                            <div>
                                <img className='w-full h-full' src="https://img.freepik.com/free-vector/new-arrival-concept-background_23-2147887363.jpg?w=740&t=st=1684564174~exp=1684564774~hmac=7285c4db34e8ce2d2abb8a7cef6ce26b55ee361ef17a9071b05012452a125cbd" alt="" />
                            </div>
